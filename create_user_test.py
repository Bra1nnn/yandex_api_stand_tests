...
# Параметр fisrtName в имени используются пробелы
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("KGJ jfjds")

# Тест 8. Ошибка при создании пользователя
# Параметр fisrtName в имени используются специальные символы
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("KGJ%%d")

# Тест 9. Ошибка при создании пользователя
# Параметр fisrtName в имени используются цифры
def test_create_user_has_number_in_first_name_get_error_response():
    negative_assert_symbol("4324")
